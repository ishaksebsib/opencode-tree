import type { FilePart, Message, OpencodeClient, Part, ReasoningPart, ToolPart } from "@opencode-ai/sdk/v2"
...
export function serializeSessionMessageRecordsForSummary(messages: readonly SessionMessageRecord[]): string {
  return messages
